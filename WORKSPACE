...
go_repository(
    name = "com_github_cespare_reflex",
    importpath = "github.com/cespare/reflex",
    sum = "h1:N4Y/UmRrjwOkNT0oQQnYsdr6YBxvHqtSfPB4mqOyAKk=",
    version = "v0.3.1",  # Usa la última versión o la que prefieras.
)
...
# En un archivo BUILD.bazel o en un archivo .bzl
